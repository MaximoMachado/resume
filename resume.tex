...
\CVItem{Gaining valuable experience working with large code bases and reading other team member's code}
...
\begin{itemize}[leftmargin=0.15in, label={}]
  \small{\item{
        ...
        \textbf{Other Tools: }{\emph{AWS, Drone.io, Terraform, Git, PostgreSql, Docker}} \\
        }}
\end{itemize}
